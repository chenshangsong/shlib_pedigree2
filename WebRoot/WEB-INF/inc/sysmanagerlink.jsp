...
<link href="${ctx}/res/sysmanager/bootstrap/css/oldbootstrap.css" rel="stylesheet"
	media="all" />
...
<script type="text/javascript" src="${ctx}/res/sysmanager/vendors/jquery-validation/dist/jquery.validate.min.js"></script>
<script src="${ctx}/res/sysmanager/assets/form-validation.js"></script>
<script src="${ctx}/res/commJS/systemvariable.js"></script>
<%--chenss --%>
<script>var ctx = "${ctx}";var ctxRoleId = "${ctxRoleId.getRoleId()}";</script>
