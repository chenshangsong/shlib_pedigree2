 ...
 *          <a href="http://msdn.microsoft.com/zh-cn/library/bb429565.aspx">Bing Maps</a>
 * </p>
 * <ul>
...
var 
    ...
    // Google icon path chenss20150615
    GIP = "https://jpv1.library.sh.cn/jp/res/plugin/timemap/images/",
 ...
 */
TimeMap.init = function(config, size) {
        ...
        config.bandInfo = [
            {
                ...
                intervalPixels: size      //可调整，显示5、10、20年的可视化数据
            },
            {
                width:          "20%",
