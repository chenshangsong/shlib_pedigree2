    ...
    <form style="padding-left: 10px;">
        ...
        <div class="input-group" style="padding-left: 20px;">
            ...
            <input type="text" id="fn-input" style="width: 150px;" class="form-control" placeholder="输入姓氏">
             <a id='hSearch'
				href="${ctx}/service/place/list"> <span
				class="btn btn-default btn-sm pull-right"><i
					class="glyphicon glyphicon-th-list"></i>&nbsp;地名列表</span></a>
        </div>
    </form>
    <hr>
...
<script src="${ctx}/res/js/normal/service/map.js"></script>
</body>
</html>
