    ...
    <form method="post" id="workForm" action="${ctx}/ancestraltempleManager/list" class="form-inline">
        ...
        <div>
            <div class="form-group">
                <label>堂号/姓氏：</label>
                <input type="text" class="form-control" name="tang" id="tang" placeholder="在此输入堂号/姓氏">
            </div>
...
<script type="text/html" id="worksTpl">
    {@each works as work, i}
        ...
        <div class="col-xs-3">
            <a href="${ctx}/ancestraltempleManager/dataContentlist?id=@{work.uri}">【@{work.fn_chs}】@{work.chs}</a>
        </div>
