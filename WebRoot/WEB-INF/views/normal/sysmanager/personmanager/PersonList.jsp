...
<body>
	...
	<div class="container">
		...
		<form role="form" id="listForm" class="form-inline">
			<input type="hidden" name="firstChar" id="firstChar" /> <input
				type="hidden" name="pageSize" value="90" />
			...
			<a class="btn btn-primary" id="btn_query"><i class="glyphicon glyphicon-search"></i>&nbsp;查 询</a> <a
				href="${ctx}/personManager/dataContentAdd"> <span
	...
	<script src="${ctx}/res/js/sysmanager/datamanager/personList.js"></script>
</body>
</html>
