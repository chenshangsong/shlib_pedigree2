...
<body>
	...
	<div class="container">
		<h2 id="top">
			攥修者编辑 <a href="${ctx}/dataManager/datalist"> <span
				class="btn btn-default btn-sm pull-right" tag="back"><i
					class="glyphicon glyphicon-chevron-left"></i>&nbsp;数据维护</span></a>
		</h2>
		<hr>
		<a href="${ctx}/personManager/dataContentAdd?type=6"> <span
			class="btn btn-default btn-sm pull-right"><i class="icon-plus"></i>&nbsp;新增
		</a>
		<form role="form" id="listForm" class="form-inline">
			...
			<div class="form-group">
				<label>姓氏：</label> <input type="text" class="form-control"
					name="familyName" id="familyName" placeholder="在此输入姓氏">
			</div>
			<div class="form-group">
			...
			<a class="btn btn-primary" id="btn_query"><i
				class="glyphicon glyphicon-search"></i>&nbsp;查 询</a>
