...
public class DataHistoryController extends BaseController {
	...
	public ModelAndView history(@Param(value = "dataUri") String dataUri,
		...
		modelAndView.setViewName("sysmanager/datahistory/confHistory");
		return modelAndView;
	}
	...
	public ModelAndView confPropertylist(@Param(value = "id") String id)
		...
		List<DataChangeHistoryListModel> data = new ArrayList<DataChangeHistoryListModel>();

		try {

			data = dataChangeHistoryMapper.selectHistoryList(id);
		...
		modelAndView.setViewName("sysmanager/datahistory/confPropertylist");
		return modelAndView;
	}
